...
public class JumiaCloneExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({JumiaCloneException.class, CartServiceException.class,
            WishListServiceException.class, UnAuthorizedException.class, ProductServiceException.class})
    public ResponseEntity<Object> handleCustomException(JumiaCloneException e) {
